...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-fit flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar h-full flex flex-col overflow-y-auto duration-300 ease-linear">
        <nav className="mt-5 h-full flex flex-col justify-between pb-5 py-4 px-4 lg:mt-9 lg:px-3">
          <div>
